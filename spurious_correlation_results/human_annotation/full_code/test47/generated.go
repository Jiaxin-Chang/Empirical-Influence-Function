...
function.
	...
	if query.Service.OnlyPassing { 		filterType = structs.HealthFilterExcludeNonPassing
	} else if query.Service.OnlyCritical {
		filterType = structs.HealthFilterExcludePassing 	}
